            ...
            {!hideMode && (
              <div className="flex gap-2">
                <button
                  ...
                  disabled={busy}
                  className="rounded-xl border border-[var(--surface-border)] bg-white px-4 py-2 text-[13px] font-semibold text-[var(--text-primary)] hover:bg-sys-gray-6 disabled:opacity-60 transition"
                >
