  ...
  return (
    <Drawer.Root open={open} onOpenChange={onOpenChange}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed inset-x-0 bottom-0 z-70 mx-auto flex h-[92dvh] max-w-2xl flex-col rounded-t-3xl bg-(--map-bg) shadow-float outline-hidden">
                ...
                {menus.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-2 border-t border-(--surface-border) px-3 py-2 text-[12px] text-(--text-secondary)">
                        ...
                        {isPdf && (
                          <a
                            ...
                            className="inline-flex items-center gap-1 rounded-full border border-(--surface-border) bg-white px-2 py-1 text-[11px] font-medium text-(--text-primary) hover:bg-sys-gray-6"
                          >
