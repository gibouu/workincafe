...
import { AdminReviewsBrowser } from '@/components/admin/AdminReviewsBrowser';

export const metadata = { title: 'Reviews · Admin · Work in Cafe' };
    ...
    <div className="min-h-dvh bg-[var(--map-bg)]">
      <div className="mx-auto max-w-4xl px-5 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-[15px] font-semibold text-[var(--text-primary)]">Reviews</div>
          <div className="w-9" />
        </div>
        <h1 className="mt-6 text-[28px] font-bold text-[var(--text-primary)]">All reviews</h1>
        <p className="mt-1 text-[14px] text-[var(--text-secondary)]">
          Search, hide, restore, or hard-delete any review across the platform.
        </p>
        <div className="mt-6">
          <AdminReviewsBrowser />
        </div>
