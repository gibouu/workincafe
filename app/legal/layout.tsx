    ...
    <div className="min-h-dvh bg-(--map-bg)">
      <header className="border-b border-(--surface-border) bg-white/80 backdrop-blur-ios">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-5 py-3">
          ...
          <div className="text-[15px] font-semibold text-(--text-primary)">Legal</div>
          <div className="w-9" />
        </div>
      </header>
      <main className="mx-auto max-w-2xl px-5 py-8 text-[15px] leading-relaxed text-(--text-primary)">
        {children}
      </main>
    </div>
  );
